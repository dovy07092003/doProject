// File name: publish_temp.cpp
// Publish the temperature from the sensor to the AIO feed
// Run:./publishtemp
#include <iostream>
#include <sstream>
#include <fstream>
...
#define TOPIC      "dovy07092003/feeds/project.temperature"
...
int main(int argc, char* argv[]) {
   ...
   AnalogIn AIN(0);
   cout<<"The pin to get the data is "<<AIN.getNumber()<<endl;
   int adc_val = AIN.readAdcSample();
   cout<<"The adc value is "<<adc_val<<endl;
   sprintf(str_payload, "%f", getTemperature(adc_val));
