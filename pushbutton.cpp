...
// Pushbutton control a status indicator on AIO. 
// Run: ./pushbutton
#include <iostream>
#include <sstream>
#include <fstream>
...
int main(int argc, char* argv[]) {
   ...
   GPIO button(46);
   cout<<"The gpio pin for the button is "<<button.getNumber()<<endl;
   int sta = button.getValue();
   cout<<"The status value is "<<sta<<endl;// Turn on when it is 1, off when it is 0
